...
pub async fn start_registry_monitor(bus: Arc<dyn EventBus>, registry: Arc<sentinel_core::CollectorRegistry>) {
    tokio::spawn(async move {
        registry.register(sentinel_core::CollectorStatus::new("registry", "Registry Monitor", "Systemd user service persistence"));
...
pub async fn start_registry_monitor(_bus: Arc<dyn EventBus>, _registry: Arc<sentinel_core::CollectorRegistry>) {
